  ...
  return (
    <div className="col-md-12 p-0 pb-5" style={{backgroundColor:"white"}}>
        ...
        <div className="col-md-12 text-center py-5 ">
            ...
            <h6><b>WHY CHOOSE SELTEQ FOR SOFTWARE NEEDS?</b></h6>
        </div>
...
Whether you need a preliminary technical design, a feasibility study, high-level architecture, or a technology selection process, the Selteq team provides comprehensive consulting services to meet your requirements.</p>
                ...
                <div className="row">
                    ...
                    <i class="fas fa-circle"></i>
                        ...
                        Customer-Tailored
                    Solutions</h5>
                        <p className="font_pa">Our software solutions are customer-specific. We listen to your needs, we understand the challenges you face, and we’ll adapt ourselves to your processes and culture.</p>
                    </div>
                    </div>
                    )}
