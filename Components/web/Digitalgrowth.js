        ...
        <div className="col-md-12 p-0" style={{ backgroundColor: "white" }}>
            <div className="col-md-12 p-0 display_h">
                <div className="col-md-12 text-center py-5 ">
                    ...
                    <h6><b>WHY USE SELTEQ FOR YOUR SOFTWARE NEEDS</b></h6>
                </div>
                    ...
                    <div className="container">
                        <div className="row" >
                                            ...
                                            {openone ? (
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-11 col-11 px-2" onClick={() => setOpenone(!openone)}>
                                                        ...
                                                        <p className="font_pa">
                                                            Our React JS developers are skilled at building a solid web application that merges SEO goals with SCAND technology to create a smooth user experience.
                                            ...
                                            {opentwo ? (
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-11 col-11 px-2" onClick={() => setOpentwo(!opentwo)}>
                                                        ...
                                                        <p className="font_pa">When it comes to creating cross-platform compatible web solutions, our AngularJS developers excel.
                                            ...
                                            {openthree ? (
                                                ...
                                                <div className="row" >
                                                    ...
                                                    <div className="col-md-11 col-11 px-2" onClick={() => setOpenthree(!openthree)}>
                                                        ...
                                                        <p className="font_pa">
                                                            We specialize in developing web applications using ASP.NET and other open-source technologies.
                                            ...
                                            {openfour ? (
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-11 col-11 px-2" onClick={() => setOpenfour(!openfour)}>
                                                        ...
                                                        <p className="font_pa">Our passion for Ruby on Rails has fueled our design of likeable web applications created with the most recent technologies.
                                            ...
                                            {openfive ? (
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-11 col-11 px-2" onClick={() => setOpenfive(!openfive)}>
                                                        <h5 className={styles.head_active}>
                                                            PHP</h5>
                                                        <p className="font_pa">We work with clients to build web applications of high quality. We are a team of qualified PHP web developers.
                            ...
                            <div className="col-md-4 text-center" >
                                <img src="https://1864597015.rsc.cdn77.org/selteqreact/images/pperson.png" className="img-fluid ig_sec_width" />
                            </div>
                        </div>
                    </div>
                </div>
