...
function Aboutus() {
  ...
  return (
    ...
    <div className='col-md-12 pl-4'>
        ...
        Headquartered in London, Selteq focuses on streamlining business process via its cutting-edge Software, App & Web Development services. Being a digital transformation stalwart, our proactive approach & futuristic developments allow us to untangle complex issues.
        </p>
    </div>
    ...
    <div className='col-md-12 pl-4 pt-3'>
        <p className='text_sub_para'>
        Our fascinating and pixel-perfect design combined with a functional website, App, or internal software − using the revolutionary tools, insights, and analysis − help businesses achieve a customer-friendly online presence made to impress.
        </p>
    </div>
