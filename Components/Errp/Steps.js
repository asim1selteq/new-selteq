  ...
  return (
    <div className="col-md-12 p-0" style={{backgroundColor:"white"}}>
        ...
        <div className="col-md-12">
            ...
            <h6 className={styles.text_gray}>EMPOWERING YOUR BESPOKE SOFTWARE</h6>
            <h5>SAY HELLO TO SMART SOFTWARE BUILT <br/> TO ENHANCE YOUR PRODUCTIVITY</h5>
            </div>
                ...
                <div className="row">
                    ...
                    <i class="fas fa-circle"></i>
                        ...
                        Inventory Management System</h5>
                        <p className="font_pa">
                        Offering order tracking, invoicing and reporting for medium and large-sized companies across multiple locations – including production. Start tracking stock levels, cost, inventory value over time.</p>
                    </div>
                    </div>
                    )}
