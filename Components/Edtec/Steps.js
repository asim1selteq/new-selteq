  ...
  return (
    <div className="col-md-12 p-0" style={{backgroundColor:"white"}}>
        ...
        <div className="col-md-12">
            ...
            <h5>IT’S NOT JUST SOFTWARE<br/> IT’S MODERN LEARNING ENVIRNOMENT</h5>
            </div>
                ...
                <div className="row">
                    ...
                    <div className="col-md-10 col-11 pl-1" onClick={()=>setOpenthree(!openthree)}>
                    <h5 className={styles.head} >
                    Online classes</h5>
                    </div>
                    </div>
