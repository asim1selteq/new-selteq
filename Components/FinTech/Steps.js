  ...
  return (
    <div className="col-md-12 p-0" style={{backgroundColor:"white"}}>
        ...
        <div className="col-md-12">
            ...
            <h5>OUR SOLUTIONS SUPPORT A NUMBER OF CORE<br/>BANKING & FINANCE ACTIVITIES</h5>
            </div>
                ...
                <div className="row">
                    ...
                    <div className="col-md-10 col-11  pl-2" onClick={()=>setOpentwo(!opentwo)}>
                    <h5 className={styles.head} >
                    Bill Payments</h5>
                    </div>
                    </div>
...
{/* Tabs */}
                ...
                {openfour ? (
                    ...
                    <i class="fas fa-circle"></i>
                        ...
                        E-Ticketing</h5>
                        <p className="font_pa">
                        We are your ultimate e-ticketing partner. Providing premium technology that lets you sell tickets quickly and easily, manage and sell memberships and set up a platform suitable for all needs. Our core technology means your tickets will accessible anywhere in the time zone.</p>
                    </div>
                    </div>
                    )}
