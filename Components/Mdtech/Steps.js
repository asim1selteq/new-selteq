  ...
  return (
    <div className="col-md-12 p-0" style={{backgroundColor:"white"}}>
        ...
        <div className="col-md-12">
            ...
            <h5>ENJOY THE BENEFITS OF CENTRALIZED<br/> HEALTHCARE MANAGEMENT SYSTEM.</h5>
            </div>
                ...
                <div className="row">
                    ...
                    <i class="fas fa-circle"></i>
                        ...
                        <h5 className={styles.head_active}>
                        Electronic Medical Record</h5>
                        <p className="font_pa">Selteq provides an Electronic Medical Record (EMR) and Practice Management (PM) solution, geared to provide value-added solutions for healthcare organizations. It helps in the daily management of patients, patients’ detail with discharge or nursing of patients, improving operational efficiency and reducing costs.</p>
                    </div>
                    </div>
                    )}
                ...
                <div className="row">
                    ...
                    <i class="fas fa-circle"></i>
                        ...
                        Scheduling System</h5>
                        <p className="font_pa">
                        Selteq provides an online scheduling platform designed to keep staff, doctors, other team members and helpdesk staff on the same page. Scheduling takes seconds, not days. Once schedules have been defined, staffing reports appear in real-time — as required.</p>
                    </div>
                    </div>
                    )}
